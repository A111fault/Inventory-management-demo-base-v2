...
function downloadExcelFile($con)
{
    ...
    // Add header row
    $headerRow = ['SN', 'Item Id', 'Item Description', 'Item Quantity', 'Unit Price', 'Date Received', 'Supplier', 'Total Price', 'Remarks'];
    $column = 'A';
                ...
                <div class="container-box">
                    <form class="my-3 mx-3" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <input type="date" class="form-control form-control-sm mb-3" name="date_received" placeholder="Received Date">
                            </div>
                            <div class="col-md-3">
